...
func (h *UserHandler) RegisterSubmit() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		h.sessions.Put(r.Context(), "flash", "Registrasi berhasil. Silahkan log in.")
...
func (h *UserHandler) LoginSubmit() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		h.sessions.Put(r.Context(), "flash", "Berhasil Log in.")
		http.Redirect(w, r, "/", http.StatusFound)
	}
}
...
func (h *UserHandler) Logout() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		h.sessions.Put(r.Context(), "flash", "Berhasil Log out.")
		http.Redirect(w, r, "/", http.StatusFound)
	}
}
